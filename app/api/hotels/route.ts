...
export async function GET(req: NextRequest) {
  ...
  const selectCols = slim
    ? `id, name, code, COALESCE(brand,'') AS brand, COALESCE(region,'') AS region, COALESCE(country,'') AS country, booking_url, tuiamello_url, expedia_url, check24_url, brand_url, bookable, active`
    : `id, name, code, COALESCE(brand,'') AS brand, COALESCE(region,'') AS region, COALESCE(country,'') AS country, booking_url, tuiamello_url, expedia_url, check24_url, brand_url, bookable, active, base_image, "globalTypes"`;
